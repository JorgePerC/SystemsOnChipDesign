...
; PORTB_PCR19         EQU  0x4004_A04C
PORTB_PCR19_MASK      EQU  0x100

; PORTB_PCR18         EQU   0x4004_A048
PORTB_PCR18_BASE      EQU  0x4004A000
PORTB_PCR18_OFFSET    EQU  0x48
PORTB_PCR18_ABSOLUTE  EQU  (PORTB_PCR18_BASE+PORTB_PCR18_OFFSET)
PORTB_PCR18_MASK      EQU  0x100
	

PORTB_BASE            EQU  0x400FF040
PORTB_PDOR_OFFSET     EQU  0x00   ; Port Data Output Register, offset: 0x0
PORTB_PDDR_OFFSET     EQU  0x14	  ; Port Data Direction Register @ 400F_F054
...
PORTB18_PDDR_MASK     EQU  0x00040000
PORTB18_PDOR_MASK     EQU  0xFFFBFFFF 

; 1) Green led is connected to PTB19
; 1) Red led is connected to PTB18
...
;    MEM[0x4004_A04C] = 0x100
    ...
    STR r3,[r1,r2]
; 	MEM[0x4004_A048] = 0x100
	LDR r1,=PORTB_PCR18_BASE
    LDR r2,=PORTB_PCR18_OFFSET
    LDR r3,=PORTB_PCR18_MASK
    STR r3,[r1,r2]

; 4.1) COnfigure PORTB PIN19 as output
    LDR r1,=PORTB_BASE
    LDR r2,=PORTB_PDDR_OFFSET
    LDR r3,=PORTB_PDDR_MASK
    STR r3,[r1,r2]

; 4.2) COnfigure PORTB PIN18 as output
    LDR r1,=PORTB_BASE
    LDR r2,=PORTB_PDDR_OFFSET
    LDR r3,=PORTB18_PDDR_MASK
    STR r3,[r1,r2]

; 5.1) Turn on Green LED
    LDR r2,=PORTB_PDOR_OFFSET
    LDR r3,=PORTB_PDOR_MASK
    STR r3,[r1,r2]


; 5.2) Turn on Red LED
    LDR r2,=PORTB_PDOR_OFFSET
    LDR r3,=PORTB18_PDOR_MASK
    STR r3,[r1,r2]
